  ...
  return (
    <div id="skills" className="lg:mt-32 bg-slate-100 p-4  rounded lg:w-8/12 mx-auto">
      ...
      <div className=" grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-10 ">
        <div className="flex gap-2 border border-gray-500 px-2 hover:scale-105 transition-all rounded-lg">
        ...
        <div className="flex border border-gray-500 px-2 hover:scale-105 transition-all rounded-lg py-2 gap-2">
